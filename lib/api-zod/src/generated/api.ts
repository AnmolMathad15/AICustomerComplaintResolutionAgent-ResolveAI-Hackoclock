...
export const AnalyzeComplaintResponse = zod.object({
  ...
  emotion: zod.enum(["anger", "frustration", "urgency", "neutral", "positive"]),
  frustrationScore: zod.number(),
  resolution: zod.string(),
  policyReference: zod.string(),
  policyCode: zod.string(),
  policyApplied: zod.string(),
  decisionAction: zod.enum([
    "refund",
    "replacement",
    "auto_resolve",
    "escalate",
  ...
  decisionReasoning: zod.array(zod.string()),
  empathyPrefix: zod.string(),
